...
import registerImage from '../../Images/RegisterImage.jpg'; // same image
    ...
    return (
        <div className="container d-flex justify-content-center align-items-center" style={{ minHeight: '100vh' }}>
            <div className="d-flex card p-0 card-border w-100 flex-column flex-md-row" style={{ maxWidth: '800px' }}>
                ...
                <div
                    className="flex-md-grow-1 p-0 d-none d-md-flex justify-content-center align-items-center"
                    style={{ flex: 1 }}
                >                    <img
                        src={registerImage}
                        alt="Register visual"
                ...
                <div className="flex-md-grow-1 p-4 signin-form" style={{ flex: 1 }}>
